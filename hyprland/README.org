...
#+begin_src conf :tangle "~/.config/hypr/hyprland.conf"
  ...
  env = XCURSOR_SIZE,32
  env = BEMENU_OPTS, --fn 'Maple Mono NF 12' --nb '##282828' --nf '##ebdbb2' --tb '##282828' --tf '##fb4934' --hb '##3c3836' --hf '##fabd2f' --fb '##282828' --ff '##ebdbb2' --ab '##282828' --af '##ebdbb2'
  ...
  bind = $mainMod CONTROL, B, layoutmsg, mfact -0.005
  bind = $mainMod CONTROL, F, layoutmsg, mfact +0.005
