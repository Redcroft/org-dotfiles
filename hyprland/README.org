...
#+begin_src conf :tangle "~/.config/hypr/hyprland.conf"
  ...
  $menu = uwsm app -- bemenu-run
  $web = uwsm app -- qutebrowser
  ...
  env = XCURSOR_SIZE,32
  env = BEMENU_OPTS, --fn 'IosevkaTerm Nerd Font 12' --nb '##282828' --nf '##ebdbb2' --tb '##282828' --tf '##fb4934' --hb '##3c3836' --hf '##fabd2f' --fb '##282828' --ff '##ebdbb2' --ab '##282828' --af '##ebdbb2'
