...
#+begin_src bash :tangle "~/.config/herbstluftwm/autostart"
  ...
  hc set frame_bg_active_color "#2fafff"
  ...
  hc attr theme.title_font 'Aporetic Sans Mono-8'
  hc attr theme.title_depth 3
  hc attr theme.active.color "#2fafff"
  hc attr theme.title_color "#000000"
  hc attr theme.normal.color "#000000"
  hc attr theme.urgent.color "#ff5f59"
  ...
  hc attr theme.floating.outer_color "#2fafff"
  hc attr theme.active.inner_color "#2fafff"
  hc attr theme.urgent.inner_color "#ff5f59"
