...
#+begin_src bash :tangle "~/.config/herbstluftwm/autostart"
  ...
  hc set frame_bg_active_color "#a277ff"
  ...
  hc attr theme.title_font 'GohuFont uni11 Nerd Font:size=8:antialias=false:hinting=false'
  hc attr theme.title_depth 3
  hc attr theme.active.color "#a277ff"
  ...
  hc attr theme.floating.outer_color "#a277ff"
  hc attr theme.active.inner_color "#a277ff"
...
** Monitors 
#+begin_src bash :tangle (when (string= system-name "heimdall") "~/.config/herbstluftwm/autostart")
