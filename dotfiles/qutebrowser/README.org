...
#+begin_src conf :tangle ~/.config/qutebrowser/quickmarks :tangle-mod (identity #o444)
  ...
  k1tm https://www.printables.com/model/891616-creality-k1-k1c-unibody-riser-frame
  k1tm2 https://www.printables.com/model/951012-creality-k1-k1c-lid-riser-v3-frame-extension-kit
...
#+begin_src python
  ...
  c.colors.completion.item.selected.border.top = "#FF00FF"

  # Bottom border color of the selected completion item.
  c.colors.completion.item.selected.border.bottom = "#FF00FF"
  ...
  c.colors.keyhint.fg = colors["background"]

  # Highlight color for keys to complete the current keychain.
  c.colors.keyhint.suffix.fg = "#FF00FF"
