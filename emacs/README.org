...
#+begin_src emacs-lisp
  (use-package emacs
    ...
    (setq-default Xft.rgba "none")
    (setq-default Xft.hintstyle "hintslight")
...
#+begin_src emacs-lisp
  ...
  ;; (use-package gruvbox-theme :ensure (:wait t))

  (global-set-key (kbd "<f5>") #'my/toggle-theme)

  (set-face-attribute 'default nil
    		    :family "Ioskeley Mono:antialias=gray:hinting=true:hintstyle=hintslight"
    		    :height 110
    		    :weight 'medium)

  (defvar my/themes '(aura base16-catppuccin-latte)
