...
#+begin_src emacs-lisp :tangle "~/.emacs.d/themes/one-half-dark-theme.el"
  ;;; one-half-theme.el --- Theme
  ...
  ;;; Commentary:
  ;;; one-half theme created by Richard in 2025

  ;;; Code:

  (deftheme one-half-dark)
  ...
  (provide-theme 'one-half-dark)

  ;; Local Variables:
  ;; no-byte-compile: t
  ;; End:

  ;;; one-half-dark-theme.el ends here
#+end_src

#+begin_src emacs-lisp :tangle "~/.emacs.d/themes/one-half-light-theme.el"
  ;;; one-half-light-theme.el --- Theme
  ...
  ;;; Commentary:
  ;;; one-half-light theme created by Richard in 2025

  ;;; Code:

  (deftheme one-half-light)
  (let ((class '((class color) (min-colors 89)))
        (fg1 "#383a42")
        (fg2 "#484a51")
        (fg3 "#585a60")
  ...
  (provide-theme 'one-half-light)

  ;; Local Variables:
  ;; no-byte-compile: t
  ;; End:

  ;;; one-half-light-theme.el ends here
#+end_src
