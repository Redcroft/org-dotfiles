  ...
  (use-package heaven-and-hell
    ...
    (setq heaven-and-hell-theme-type 'dark
  	...
  	'((dark   . base16-gruvbox-material-dark-hard)
  	  (light  . base16-gruvbox-material-light-hard))
  	heaven-and-hell-load-theme-no-confirm t)
    :custom-face
    (default ((t (:family "JetBrainsMono Nerd Font" :height 110 :weight Semibold))))
...
#+end_src
***** Lincoln
#+begin_src emacs-lisp :tangle "~/.emacs.d/theme/dracula-pro-lincoln-theme.el"
...
#+end_src
***** Morbius
#+begin_src emacs-lisp :tangle "~/.emacs.d/theme/dracula-pro-morbius-theme.el"
