...
#+begin_src sh
  ...
  if [ ! -d ~/.local/share/fonts/SF-Mono ]; then
      git clone --depth=1 git@github.com:supercomputra/SF-Mono-Font ~/.local/share/fonts/SF-Mono
  fi
  if [ ! -d ~/.config/godot/text_editor_themes/godot-syntax-themes ]; then
