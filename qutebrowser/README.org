...
#+begin_src python :tangle "~/.config/qutebrowser/config.py"
  ...
  # Modus Vivendi (no packaged qutebrowser theme)
  bg, fg, dim, sel = "#000000", "#ffffff", "#989898", "#5a5a5a"
  accent, red, green, yellow = "#2fafff", "#ff5f59", "#44bc44", "#d0bc00"
  bg_dim = "#1e1e1e"

  c.colors.completion.fg = fg
  c.colors.completion.odd.bg = bg
  c.colors.completion.even.bg = bg_dim
  ...
  c.colors.statusbar.command.bg = bg_dim
  c.colors.statusbar.command.fg = fg
  c.colors.statusbar.caret.bg = "#feacd0"
  c.colors.statusbar.caret.fg = bg
  c.colors.statusbar.passthrough.bg = "#00d3d0"
  ...
  config.bind("<z><f>", "spawn freetube {url}")
  config.bind("<z><a>", "spawn mpv --no-video --ytdl-format='bestaudio' {url}")
