...
#+begin_src lisp :tangle (if (string= system-name "red") "/sudo::/etc/kanata/config.kbd" "")
  ...
  (deflayer graphite
      ...
      lctl n  r  t  s  g  y  h  a  e  i   ,   \
      lsft \  q  x  m  c  v  k  p  .  -   /   rsft
      lctl lmet  lalt  spc  @lwr  rctl  lft  up  down rght)

  (deflayer lower
      _    _    _    _    _  _  _  _  _  _  _   _   _   _    _    _
      _    @cmk @qwr @ght _  _  _  _  _  _  _   _   _   _
...
#+begin_src lisp :tangle (if (string= system-name "heimdall") "/sudo::/etc/kanata/config.kbd" "")
  (defcfg
      linux-dev ( /dev/input/by-id/usb-hfd.cn_USB_DEVICE-event-kbd
  		/dev/input/by-id/usb-hfd.cn_USB_DEVICE-if01-event-mouse
  ...
  (defsrc
      esc  1  2  3  4  5  6  7  8  9  0   -   =   bspc vold volu
  ...
  (deflayer colemak
      esc  1  2  3  4  5  6  7  8  9  0   '   =   bspc brdwn brup
