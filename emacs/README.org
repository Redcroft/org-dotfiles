...
#+begin_src emacs-lisp
  (use-package exwm
    ...
    (defun red/inc-bright (val)
      (interactive)
      (with-temp-buffer
        (insert-file-contents "/sys/class/backlight/amdgpu_bl1/brightness")
    ...
    (defun red/set-bright (val)
      (interactive)
      (write-region (number-to-string (min (max val 0) 255)) nil "/sys/class/backlight/amdgpu_bl1/brightness"))
