#+Property: Header-args :tangle ~/.config/qutebrowser/config.py :tangle-mode (identity #o444) :mkdirp yes
#+auto_tangle: t
...
#+begin_src conf :tangle ~/.config/qutebrowser/quickmarks :tangle-mod (identity #o444)
  ...
  cable_01 https://www.printables.com/model/126820-simplest-cable-organizer
  cable_02 https://www.printables.com/model/456502-cable-storage-box
  cable_03 https://www.printables.com/model/842990-gridfinity-cable-storage
  cable_04 https://www.printables.com/model/154307-universal-cable-organizer
  cable_05 https://www.printables.com/model/833200-gridfinity-cable-storage
  dxvk_dlss https://github.com/jp7677/dxvk-nvapi/issues/254#issuecomment-2629379273
#+end_src
...
#+begin_src python
  ...
  c.colors.messages.info.fg = colors["background"]
  ...
  c.colors.statusbar.normal.fg = colors["background"]
  ...
  c.colors.tabs.selected.odd.bg = colors["magenta"]

  # Foreground color of selected even tabs.
  c.colors.tabs.selected.even.fg = colors["background"]

  # Background color of selected even tabs.
  c.colors.tabs.selected.even.bg = colors["magenta"]
#+end_src

** Userscripts
#+begin_src sh :tangle "~/.local/share/qutebrowser/userscripts/qute-rbw" :tangle-mode (identity #o777) :mkdirp yes
#!/usr/bin/env python3
...
** Greasemonkey
**** Bypass Shorturls
#+begin_src javascript :tangle "~/.config/qutebrowser/greasemonkey/bypass-short.js"
  // ==UserScript==
...
**** Youtube ADB
#+begin_src javascript :tangle "~/.config/qutebrowser/greasemonkey/yt-ad.js"
#+end_src
g
